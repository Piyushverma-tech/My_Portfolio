...
const Recipick = () => {
  ...
  return (
    <div className="bg-gradient-to-br from-gray-900 via-black to-gray-800  min-h-screen">
      ...
      <header className="bg-black pb-4 pt-14 px-6 relative overflow-hidden border-b border-cyan-400/20">
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          <div className="flex flex-col md:flex-row items-center justify-between">
            <div className="md:w-1/2 mb-8 md:mb-0 max-sm:text-center relative">
              <h1 className="text-3xl text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 via-green-400 to-cyan-300 md:text-5xl font-bold mb-4 max-md:mt-6 tracking-tight relative">
                Recipick
              ...
              <motion.div
                className="w-28 h-px max-sm:mx-auto bg-gradient-to-r from-cyan-400 to-green-400 mb-6"
                animate={{
                  opacity: [0.6, 1, 0.6],
                }}
                transition={{
            ...
            <div className="md:w-1/2 relative">
              {/* Cyberpunk device frame with holographic effect */}
              <motion.div
                className="relative"
                animate={{
                  y: [0, -10, 0],
      ...
      <section className="py-12 px-4 md:py-16 md:px-6">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-2xl md:text-3xl text-green-400 font-bold mb-8 md:mb-12 relative">
            Project Overview{' '}
            <motion.span
              animate={{ rotate: 360 }}
              transition={{
          ...
          <div className="space-y-8 md:space-y-12">
            <div className="bg-black/50 border border-green-400/30 backdrop-blur-sm shadow-sm p-6 md:p-8">
              <h3 className="text-xl text-cyan-400 md:text-2xl font-semibold mb-3 md:mb-4 ">
                Problem
              </h3>
              <p className="text-gray-200 text-base md:text-lg leading-relaxed">
      ...
      <section className="py-12 px-4 md:py-16 md:px-6">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-2xl text-green-400 md:text-3xl font-bold mb-8 md:mb-12 relative">
            Project Foundation{' '}
            <motion.span
              animate={{ rotate: 360 }}
              transition={{
          ...
          <div className="space-y-8 md:grid md:grid-cols-2 md:gap-8 md:space-y-0  ">
            <div className="bg-black/50 border border-green-400/30 backdrop-blur-sm p-6 md:p-8">
              <h3 className="text-xl text-cyan-400 md:text-2xl font-semibold mb-3 md:mb-4">
                Goals
              </h3>
              <ul className="list-disc text-base md:text-lg pl-5 text-gray-200 space-y-6 ">
                <li>
            ...
            <div className="bg-black/50 border border-green-400/30 backdrop-blur-sm p-6 md:p-8">
              <h3 className="text-xl md:text-2xl text-cyan-400 font-semibold mb-3 md:mb-4">
                Target Audience
              </h3>

              <ul className="list-disc pl-5 text-base md:text-lg text-gray-200 space-y-6 mb-4">
                <li>
      ...
      <section className="py-12 px-4 md:py-16 md:px-6">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="bg-black/50 border border-green-400/30 backdrop-blur-sm p-6 md:p-8 mb-8">
      ...
      <section className="py-16 px-6  ">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-2xl md:text-3xl text-green-400 font-bold mb-12 relative">
            User Personas{' '}
            <motion.span
              animate={{ rotate: 360 }}
              transition={{
          ...
          <div className="grid  gap-6">
            ...
            <div>
              <img
                src="https://res.cloudinary.com/dsrmecb5y/image/upload/v1753982078/Frame_49_hlsd0f.png"
                alt="User Persona"
                loading="lazy"
                className="w-full"
              />
            ...
            <div>
              <img
                src="https://res.cloudinary.com/dsrmecb5y/image/upload/v1753982085/Frame_50_skrszi.png"
      ...
      <section className="py-16 px-6  ">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid  gap-12">
            ...
            <div>
              <img
                src="https://res.cloudinary.com/dsrmecb5y/image/upload/v1753982072/Desktop_-_15_tflk6u.png"
      ...
      <section className="py-16 px-6  ">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-2xl text-green-400 md:text-3xl font-bold mb-12 relative">
            User Flow{' '}
            <motion.span
              animate={{ rotate: 360 }}
              transition={{
          ...
          <div className="grid  gap-12">
            <div>
              <img
                src="https://res.cloudinary.com/dsrmecb5y/image/upload/v1753982071/Desktop_-_16_mvcfkd.png"
                alt="User Flow"
                loading="lazy"
                className="w-full "
              />
      ...
      <section className="py-12 px-4 md:py-16 md:px-6 ">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
            <div className="bg-black/50 p-6 border border-green-400/30 backdrop-blur-sm">
      ...
      <section className="py-16 px-6  ">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid  gap-16">
            <div>
              <img
                src="https://res.cloudinary.com/dsrmecb5y/image/upload/v1753982094/Desktop_-_17_h42tyd.png"
                loading="lazy"
      ...
      <section className="py-16 px-6  ">
        <div className="max-w-5xl mx-auto">
          ...
          <div>
            <img
              src="https://res.cloudinary.com/dsrmecb5y/image/upload/v1753982079/Desktop_-_19_fbrooj.png"
              alt="Style Guide"
              loading="lazy"
              className="w-full "
            />
          ...
          <div className="space-y-8 mt-4 md:grid md:grid-cols-2 md:gap-8 md:space-y-0 ">
            <div className="bg-black/50 border border-green-400/30 backdrop-blur-sm p-6 md:p-8 ">
              <h3 className="text-xl text-cyan-400 font-semibold mb-3 md:mb-4">
                Typography
              </h3>
              <ul className="list-disc text-base md:text-lg pl-5 text-gray-200 space-y-6">
                <li>
      ...
      <section className="py-16 px-6  ">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid  gap-16">
            <div>
              <img
                src="https://res.cloudinary.com/dsrmecb5y/image/upload/v1753982093/Desktop_-_18_qw1vfi.png"
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row gap-12">
            <div className="flex-1 p-4">
              <h3 className="text-xl md:text-2xl text-cyan-400 font-semibold mb-4">
                Sign up
              </h3>
              <video
                controls
      ...
      <section className="py-12 px-4 md:py-16 md:px-6 ">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
            <div className="bg-black/50 border border-green-400/30 backdrop-blur-sm p-6 md:p-8">
              <h3 className="text-xl text-cyan-400 md:text-2xl font-semibold mb-6">
                Results
              </h3>
              <ul className="list-disc pl-5 text-base md:text-lg text-gray-200 space-y-6 mb-4">
                <li>
