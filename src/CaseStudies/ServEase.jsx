...
const ServEase = () => {
  ...
  return (
    <div className="bg-gray-50 min-h-screen font-sans">
      {/* Case Study Header */}
      <header className="bg-serveasebackground  pb-4 pt-14 px-6 ">
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row items-center justify-between">
            <div className="md:w-1/2 mb-8 md:mb-0 max-sm:text-center">
              <h1 className="text-3xl text-serveasetext md:text-5xl font-bold mb-4 max-md:mt-6 tracking-tight">
                ServEase - Case Study
              </h1>
              <p className="text-lg md:text-xl max-w-xl leading-relaxed mb-6">
              ...
              <div className="flex flex-col items-center sm:flex-row gap-4 mb-6">
                <div className="text-serveasetext  backdrop-blur-sm rounded-lg px-4 py-2">
                ...
                <a
                  ...
                  className="inline-flex items-center justify-center bg-serveasetext transition-colors duration-300 text-white font-medium rounded-lg px-6 py-3 shadow-md hover:shadow-lg"
                >
                  <svg
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid  gap-12">
            ...
            <div>
              ...
              <img
                src="https://res.cloudinary.com/dsrmecb5y/image/upload/v1744464238/hfakg9spqecxdzi5lpdr.png"
            ...
            <div>
              ...
              <img
                src="https://res.cloudinary.com/dsrmecb5y/image/upload/v1744464401/m6ypdyhtzgtcy4v5zj9m.png"
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid  gap-12">
            ...
            <div>
              ...
              <img
                src="https://res.cloudinary.com/dsrmecb5y/image/upload/v1744464231/juaiphzepww0tamesz2m.png"
            ...
            <div>
              ...
              <img
                src="https://res.cloudinary.com/dsrmecb5y/image/upload/v1744464332/encrb5gqplvlz8grdqud.png"
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid  gap-12">
            ...
            <div>
              ...
              <img
                src="https://res.cloudinary.com/dsrmecb5y/image/upload/v1744464250/dm5tjawe5uczhmphllen.png"
            ...
            <div>
              ...
              <img
                src="https://res.cloudinary.com/dsrmecb5y/image/upload/v1744464329/zljslodjpifswechgvcn.png"
